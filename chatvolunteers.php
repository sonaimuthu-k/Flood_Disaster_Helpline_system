...
echo '<table border="0" cellspacing="2" cellpadding="2"> 
      <tr> 
          ...
          <td> <font face="Arial">Chat another User Name</font> </td> 
          <td> <font face="Arial">Message</font> </td> 
             </tr>';
			 
			 $query = "SELECT * FROM chatv ";
$rs=mysqli_query($conn,$query);
    ...
    while($row=mysqli_fetch_array($rs)) {
		...
		$sqlm="select * from volunteer where volunteer_id='$useridm'";
		...
		$sqlmd="select * from volunteer where volunteer_id='$roomchat'";
