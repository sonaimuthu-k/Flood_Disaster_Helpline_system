...
<body>
  <?php require 'header.php'; ?>
    ...
    <div class="">
       <div class="" id="">
        <form action="loginv.php" class="" method="post">
          <label class="text-muted font-weight-bold" class="text-muted font-weight-bold"> Email</label>
          <input type="email" name="email" placeholder="Volunteer Email" class="form-control mb-4">
          <label class="text-muted font-weight-bold" class="text-muted font-weight-bold"> Password</label>
          <input type="password" name="password" placeholder="Volunteer Password" class="form-control mb-4">
...
$password1=($password);
	...
	//Create query
	$qry="SELECT * FROM volunteer WHERE email='$email' and password='$password1' ";
	$query=mysqli_query($conn,$qry);
	 $count = mysqli_num_rows($query);
                                    ...
                                    if ($count > 0) {
                                        ...
                                        $_SESSION['SESS_MEMBER_IDv'] = $row['volunteer_id'];
    ...
    <a href="vregister.php" class="text-center mb-4" title="Click here">Don't have account?</a>
	</div>
</div>
</div>
</div>
