...
?>
	...
	$uquery=mysqli_query($conn,"select * from volunteer where volunteer_id='3'");
...
<style>
    body{
    background: url(jastimage/bb16.jpg) no-repeat center;
...
<body>
<div>
	<h4>Welcome, <?php echo $_SESSION['SESS_admin_NAME'];?> </h4>
	<?php
