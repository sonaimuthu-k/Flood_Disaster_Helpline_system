<nav class="navbar navbar-expand-sm navbar-light bg-dark sticky-top">
    ...
    <span class="navbar-title">Online Flood Disaster Helpline System </span>
</a>
 ...
 <!--<li class="nav-item">
                <a class="nav-link btn btn-light" href="volunteer.php">Volunteer</a>
            </li>
			
 <li class="nav-item">
                <a class="nav-link btn btn-light" href="register.php">Public</a>
            </li>-->
...
<style>
    .navbar-title {
    display: inline-block; /* Ensures the text wraps properly */
